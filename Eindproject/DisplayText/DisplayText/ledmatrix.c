...
char addressOfrow[]= {0x00,0x02,0x04,0x06,0x08,0x0A,0x0C,0x0E};

/*
	getRowAddress(int)

	This method returns the address of the given row
*/
char getRowAddress(int row)
{
	return addressOfrow[row];
}
